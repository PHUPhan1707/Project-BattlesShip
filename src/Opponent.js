class Opponent {
	...
	static shootCell2() {
		var d = OpponentAIE.giveCell();
		Game.shootCell('opponent', d[0], d[1]);
		MessageBox.addMsg('<span class="box_text" id="text_' + Player.grid[d[0]][d[1]] + '">' + Game.stateCodeToString(Player.grid[d[0]][d[1]]) + '!</span> Opponent shot cell <b>' + Game.cellCodeToString(d[0], d[1]) + '</b>');
	}
}